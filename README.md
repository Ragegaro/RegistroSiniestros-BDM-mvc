...
Las fotos del siniestro se guardan en BLOB por requisitos de evaluacion, pero eso puede generar una BD muy pesada 
 ...
 En la Tabla siniestro en el atributo direccion se optó por que un tipo TEXT por simiplicidad académica, pero en produccion se recomienda Latitud y Logitud en DECIMAL via API de google mpas